...
public class TableImpl extends StructuralNodeImpl implements Table {
    ...
    protected TableImpl(String context, Map<String, Object> attributes, List<String> roles, List<String> options, Object content, List<StructuralNode> blocks, int level, String contentModel, List<String> subs) {
